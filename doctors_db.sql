...
INSERT INTO `appointments` VALUES (8,1,13,'2025-06-10','Behind jain basti, Near Param Computers, Mangalvar peth','Som Revankar',0,0),(9,2,13,'2025-06-10','Behind jain basti, Near Param Computers, Mangalvar peth','Som Revankar',0,0),(10,1,13,'2025-06-10','Behind jain basti, Near Param Computers, Mangalvar peth','Som Revankar',0,0),(11,3,13,'2025-06-10','gaffar market','neyax wills',0,0),(12,3,13,'2025-06-10','gaffar market','neyax wills',0,0);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_insert_doctor_login` BEFORE INSERT ON `doctor_login` FOR EACH ROW BEGIN
    DECLARE doctor_name VARCHAR(255);
    
    SELECT name INTO doctor_name FROM doctors_table WHERE id = NEW.doctor_id;

    SET NEW.name = doctor_name;
END */;;
DELIMITER ;
...
INSERT INTO `doctors_table` VALUES (1,'Dr. John Doe','Cardiologist',4.5,1,0,200.00,'somrevankar1510@okaxis',100),(2,'Dr. Jane Smith','Dermatologist',4.0,1,0,200.00,'somrevankar1510@okaxis',100),(3,'Dr. Emily Jones','Pediatrician',4.2,1,0,200.00,'somrevankar1510@okaxis',100),(4,'Dr. John Gal','Cardiologist',4.5,2,1,200.00,'somrevankar1510@okaxis',100),(5,'Dr. Janny Smith','Dermatologist',4.0,2,0,200.00,'somrevankar1510@okaxis',100),(6,'Dr. Essa Jones','Pediatrician',4.2,2,0,200.00,'somrevankar1510@okaxis',100),(7,'Dr. Anil Deshmukh','Cardiologist',4.8,3,0,200.00,'somrevankar1510@okaxis',100),(8,'Dr. Priya Patil','Dermatologist',4.6,3,0,200.00,'somrevankar1510@okaxis',100),(9,'Dr. Sanjay Kulkarni','Pediatrician',4.5,3,0,200.00,'somrevankar1510@okaxis',100),(10,'Dr. Anil Deshmukh','Cardiologist',4.8,3,0,200.00,'somrevankar1510@okaxis',100),(11,'Dr. Priya Patil','Dermatologist',4.6,3,0,200.00,'somrevankar1510@okaxis',100),(12,'Dr. Sanjay Kulkarni','Pediatrician',4.5,3,0,200.00,'somrevankar1510@okaxis',100),(13,'Dr. Neha Joshi','General Surgeon',4.0,4,3,200.00,'somrevankar1510@okaxis',3),(14,'Dr. Rahul More','Orthopedic',4.6,4,0,200.00,'somrevankar1510@okaxis',100),(15,'Dr. Sheetal Patil','Gynecologist',4.9,4,0,200.00,'somrevankar1510@okaxis',100),(16,'Dr. Shweta Nair','General Surgeon',4.5,5,0,200.00,'somrevankar1510@okaxis',100),(17,'Dr. Amit Bhosle','Dermatologist',4.4,5,0,200.00,'somrevankar1510@okaxis',100),(18,'Dr. Neha Rao','Anesthesiologist',4.3,5,0,200.00,'somrevankar1510@okaxis',100);
...
CREATE TABLE `patient_history` (
  ...
  `rating_given` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `hospital_id` (`hospital_id`),
  KEY `doctor_id` (`doctor_id`),
  KEY `user_id` (`user_id`),
...
INSERT INTO `patient_history` VALUES (1,1,1,1,'2025-01-14','Cancer','NA',0),(2,1,1,2,'2025-01-14','Cancer stage 4','NA',0),(3,1,4,13,'2025-05-08','Cancer','NA',0),(4,1,4,13,'2025-05-08','Cancer','NA',0),(5,1,4,13,'2025-05-08','Cancer Stage 4','NA',0),(6,1,4,13,'2025-05-08','Cancer Stage 4','NA',0),(7,2,4,13,'2025-05-09','Cancer','NA',1),(14,2,4,13,'2025-05-09','TB','NA',1),(16,1,4,13,'2025-06-10','asdw','dadw',NULL),(17,1,4,13,'2025-06-10','sdaw','dwadw',NULL),(18,2,4,13,'2025-06-10','sadwdw','wdaw',NULL),(19,1,4,13,'2025-06-10','xyz','xyz',NULL),(20,2,4,13,'2025-06-10','xyz','xyz',NULL),(21,1,4,13,'2025-06-10','dasdw','adwdw',NULL),(22,2,4,13,'2025-06-10','dsdadas','sadsad',NULL),(23,1,4,13,'2025-06-10','dsad','dawd',NULL),(24,2,4,13,'2025-06-10','dasdd','addw',NULL),(25,1,4,13,'2025-06-10','abbdwsd','adwdw',NULL),(26,1,4,13,'2025-06-10','ffadasd','fadd',NULL),(27,2,4,13,'2025-06-10','sda','adw',NULL),(28,1,4,13,'2025-06-10','ddsfs','dsf',NULL),(29,2,4,13,'2025-06-10','wdq','sda',NULL),(31,1,4,13,'2025-06-10','adsww','adww',NULL);
...
INSERT INTO `users` VALUES (1,'Som Revankar','somrevankar1510@gmail.com','somcr1510','09823857079','2002-10-15','$2b$12$kMbL6F2JWIUuZYjpZz48Tud1.jbKNlhyCZ/himKmKLQu4VfSoSpRK'),(2,'neyax wills','somrevankar@gmail.com','wiliti','+12018577757','2020-06-11','$2b$12$RM/2iX7pSyRs9xMBwACkg.H1rQMRFgSRnCIRmNP.O1xTSuJ18b.ua'),(3,'neyax wills','avantikapatil008@gmail.com','testwills','9823857079','2002-12-11','$2b$12$0B2yhC/9dO1Yvn1MVLX3yuU34gCAedsvK2uI.8E96VUEETimv.GEi');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'doctors_db'
--

--
-- Dumping routines for database 'doctors_db'
--
...
-- Dump completed on 2025-06-10 11:49:51
